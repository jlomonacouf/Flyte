...
class Profile extends React.Component {
  ...
  render() {
    ...
    if (view_id===my_id){
      //HERE MAKE IT FUNCTIONAL 
      var privacy = (this.state.user.public)? "PUBLIC" : "PRIVATE"; 

      button=<Button small style={{ backgroundColor: argonTheme.COLORS.INFO }} >{privacy}
      </Button>
    }else {
      button=<Button small style={{ backgroundColor: argonTheme.COLORS.INFO }} >Follow</Button>
    }
    return (
            ...
            >
              <Block flex style={styles.profileCard}>
                ...
                <Block style={styles.info}>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('Followers', { item: this.state.user.username })}>
                    <Block middle>
